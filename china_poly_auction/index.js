...
let palettes = [["#1c0113", "#6b0103", "#a30006", "#c21a01", "#f03c02"]]
...
//   return mc
// }
// palettes = palettes.sort((a, b) => a.reduce((s,v)=>s+chroma.distance(v,'red','hsl')) - b.reduce((s,v)=>s+chroma.distance(v,'red','hsl'))).slice(0,1)
...
function saveImage() {
  ...
  link.setAttribute('download', `poly${zeroPad(tick,6)}.png`);
