...
let minWinSize
var r
// let gr = r.group(100, 100,r)
// gr.rect(10,10,100,100)
// r.add(new Rune.Group(10,10))
...
function mouseClicked() {
  ...
  data.forEach(d => {
    let side = d.size * 3
    r.rect(d.x*sc, d.y*sc, side*sc, side*sc).fill(d.color).stroke(false)
  })
  r.draw();
}
...
function windowResized() {
  ...
  document.querySelector('svg').setAttribute('width', minWinSize)
  document.querySelector('svg').setAttribute('height', minWinSize)
  // r.height=minWinSize
}
