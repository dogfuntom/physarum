...
let texBazar = twgl.createTexture(gl, {
  src: document.querySelector("img#bazar"),
  target: gl.TEXTURE_CUBE_MAP,
}, (img) => { console.log("image loaded4") })

let texXiao = twgl.createTexture(gl, {
  src: document.querySelector("img#xiao"),
  target: gl.TEXTURE_CUBE_MAP,
}, (img) => { console.log("image loaded4") })
...
function draw(time) {
  ...
  // console.log((new Date() - timeLounch) / 1000)
