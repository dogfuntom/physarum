...
canvas.setAttribute('width', gifConfig.size)
canvas.setAttribute('height', gifConfig.size)
...
(function animate(now) {
  draw(now / 1000);
  if(tick<gifConfig.numberOfFrames){
